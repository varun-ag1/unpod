...
from libs.core.constant import DATETIME_FIELDS, DATETIME_FORMAT

# import time

# Initialize timezone - will be set by services during startup
_tz = pytz.timezone("Asia/Kolkata")  # Default timezone


def set_timezone(timezone_str):
    """Set the timezone for datetime operations. Called by services during startup."""
    global _tz
    _tz = pytz.timezone(timezone_str)
...
tz = _tz  # For backward compatibility
