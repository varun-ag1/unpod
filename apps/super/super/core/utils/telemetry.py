...
from super.configs.app_configs import DISABLE_TELEMETRY

CUSTOMER_UUID_KEY = "customer_uuid"
UNPOD_TELEMETRY_ENDPOINT = "https://telemetry.super_store.ai/anonymous_telemetry"
...
def optional_telemetry(
    ...
    try:
        ...
        # Should never interfere with normal functions of Unpod
        pass
