...
import { useMaybeTrackRefContext, useMultibandTrackVolume, TrackReferenceOrPlaceholder } from '@livekit/components-react';
...
interface CircularVisualizerConfig {
  color?: string;
  activeColor?: string;
  image?: string;
}
...
const CircularVisualizer: React.FC<CircularVisualizerProps> = ({ config, state, trackRef, barCount = 40 }) => {
